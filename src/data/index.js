...
export const CALL_TO_ACTION_DATA = {
    ...
    paragraph: "Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eufugiat nulla pariatur. Lorem Ipsum is simply dummy text of the printing laborum  perspiciatis unde.",
    posts: [{
            title: "Responsive \n Design",
            extraClassName: " ",
            icon: "piloz-devices"
...
export const APP_FEATURE_DATA = {
    ...
    image: appFeature1,
    paragraph: "Duis aute irure dolor in reprehenderit in voluptate velit esse cillum lorem ipsum is simply free.",
    options: [{
